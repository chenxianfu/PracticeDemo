...
public class HorizontalselectedView extends View {
    ...
    private List<String> strings = new ArrayList<>();//数据源字符串数组

    private int seeSize = 3;//可见个数
    ...
    private void initPaint() {
        ...
        selectedPaint.setTextSize(DisplayUtil.sp2px(context,selectedTextSize));
    }
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        //两种字体颜色和字体大小
        seeSize = tta.getInteger(R.styleable.HorizontalselectedView_HorizontalselectedViewSeesize, 3);
        ...
        textSize = tta.getFloat(R.styleable.HorizontalselectedView_HorizontalselectedViewTextSize, 18);
