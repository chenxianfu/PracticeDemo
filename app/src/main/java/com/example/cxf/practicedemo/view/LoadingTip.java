    ...
    public void setLoadingTip(LoadStatus loadStatus){
        switch (loadStatus){
            case empty: //数据为空
                ...
                tv_tips.setText(getContext().getText(R.string.app_name).toString());
                img_tip_logo.setImageResource(R.drawable.bg_no_content);
                break;
            case sereverError: //服务器失败
                setVisibility(View.VISIBLE);
                img_tip_logo.setVisibility(View.VISIBLE);
                progress.setVisibility(View.GONE);
                ...
                img_tip_logo.setImageResource(R.drawable.icon_wrong);
                break;
            case error: //无网络
                setVisibility(View.VISIBLE);
                img_tip_logo.setVisibility(View.VISIBLE);
            ...
            case loading:
                ...
                tv_tips.setText(getContext().getText(R.string.net_loading).toString());
                break;
            case finish:
                setVisibility(View.GONE);
                break;
